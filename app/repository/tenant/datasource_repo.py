...
class DatasourceRepository(BaseRepository[Datasource]):
    ...
    async def find_all_by_name_and_org(self, name: str, org_id: int) -> list[Datasource]:
    ...
    async def find_all_active_by_org(self, org_id: int) -> list[Datasource]:
    ...
    async def find_all_by_org_and_approval_status(
        self,
        org_id: int,
    ...
    async def find_all_by_org_and_status(
        self,
        org_id: int,
